  ...
  sections: [
    ...
    },
    {
      ...
      data: {
        ...
        items: [
          { title: 'Стабильно и прозрачно', description: 'Одна подписка заменяет десятки отдельных покупок. Утренний кофе — дешевле.' },
  ...
  sections: [
    ...
    },
    {
      ...
      data: {
        ...
        phone: '+7 (7xx) xxx-xx-xx',
        links: [
          { label: 'Құпиялылық саясаты', url: '#' },
          { label: 'Пайдалану шарттары', url: '#' },
          { label: 'Оферта', url: '#' }
        ]
      }
    }
